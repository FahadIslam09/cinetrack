...
interface PreviousHomeViewProps {
  searchParams?: Promise<{ feed?: string; legacy?: string }>;
}

export async function PreviousHomeView({ searchParams }: PreviousHomeViewProps) {
